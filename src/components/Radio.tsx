    ...
    const getColorClasses = () => {
      ...
      const colorVariants = {
        default: {
          ...
          bordered: {
            base: "border-2 border-gray-300/70 bg-white shadow-sm backdrop-blur-sm",
            checked: "border-gray-700 bg-gray-50/80 ring-2 ring-gray-500/40 shadow-md border-gray-600",
            hover: "hover:bg-gray-50/60 hover:border-gray-600 hover:shadow-sm active:scale-[0.98] transition-all duration-200 ease-in-out",
            dot: "bg-gray-700",
            focus: "focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-gray-500",
          },
          light: {
          ...
          ghost: {
            ...
            checked: "bg-gray-100/80 border border-gray-200/60 shadow-sm backdrop-blur-sm",
            hover: "hover:bg-gray-50/40 hover:border-gray-200/40 active:scale-[0.98] transition-all duration-200 ease-in-out",
            dot: "bg-gray-700",
            focus: "focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-gray-400",
          },
          flat: {
            base: "border-0 bg-gray-100/60 shadow-inner",
            checked: "bg-gray-200/80 shadow-md ring-1 ring-gray-300/50",
            hover: "hover:bg-gray-150/70 hover:shadow-sm active:scale-[0.98] transition-all duration-200 ease-in-out",
            dot: "bg-gray-700",
            focus: "focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-gray-400",
          },
          soft: {
        ...
        primary: {
          ...
          bordered: {
            base: "border-2 border-primary/50 bg-white shadow-sm backdrop-blur-sm",
            checked: "border-primary bg-primary/8 ring-2 ring-primary/40 shadow-md border-primary",
            hover: "hover:bg-primary/5 hover:border-primary/80 hover:shadow-sm active:scale-[0.98] transition-all duration-200 ease-in-out",
            dot: "bg-primary",
            focus: "focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary",
          },
          light: {
          ...
          ghost: {
            base: "border border-transparent bg-transparent",
            checked: "bg-primary/8 border border-primary/30 shadow-sm backdrop-blur-sm",
            hover: "hover:bg-primary/4 hover:border-primary/20 active:scale-[0.98] transition-all duration-200 ease-in-out",
            dot: "bg-primary",
            focus: "focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary",
          },
          flat: {
            base: "border-0 bg-primary/8 shadow-inner",
            checked: "bg-primary/20 shadow-md ring-1 ring-primary/40",
            hover: "hover:bg-primary/12 hover:shadow-sm active:scale-[0.98] transition-all duration-200 ease-in-out",
            dot: "bg-primary",
            focus: "focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary",
          },
          soft: {
        ...
        secondary: {
          ...
          bordered: {
            base: "border-2 border-cyan-500/50 bg-white shadow-sm backdrop-blur-sm",
            checked: "border-cyan-600 bg-cyan-500/8 ring-2 ring-cyan-500/40 shadow-md border-cyan-600",
            hover: "hover:bg-cyan-500/5 hover:border-cyan-600/80 hover:shadow-sm active:scale-[0.98] transition-all duration-200 ease-in-out",
            dot: "bg-cyan-600",
            focus: "focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-cyan-500",
          },
          light: {
          ...
          ghost: {
            base: "border border-transparent bg-transparent",
            checked: "bg-cyan-500/8 border border-cyan-500/30 shadow-sm backdrop-blur-sm",
            hover: "hover:bg-cyan-500/4 hover:border-cyan-500/20 active:scale-[0.98] transition-all duration-200 ease-in-out",
            dot: "bg-cyan-600",
            focus: "focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-cyan-500",
          },
          flat: {
            base: "border-0 bg-cyan-500/8 shadow-inner",
            checked: "bg-cyan-500/20 shadow-md ring-1 ring-cyan-500/40",
            hover: "hover:bg-cyan-500/12 hover:shadow-sm active:scale-[0.98] transition-all duration-200 ease-in-out",
            dot: "bg-cyan-600",
            focus: "focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-cyan-500",
          },
          soft: {
